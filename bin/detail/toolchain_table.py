...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('osx-10-12-cxx14-fpic', 'Xcode', osx_version='10.12'),
      Toolchain('osx-10-12-cxx17', 'Xcode', osx_version='10.12'),
      Toolchain('osx-10-12-cxx17-fpic', 'Xcode', osx_version='10.12'),
      ...
      Toolchain('osx-10-13-dep-10-10-cxx14-fpic', 'Xcode', osx_version='10.13'),
      Toolchain('osx-10-13-dep-10-10-cxx17', 'Xcode', osx_version='10.13'),
      Toolchain('osx-10-13-dep-10-10-cxx17-fpic', 'Xcode', osx_version='10.13'),
      ...
      Toolchain('osx-10-13-cxx17-fpic', 'Xcode', osx_version='10.13'),
      ...
      Toolchain('osx-10-14-cxx17-fpic', 'Xcode', osx_version='10.14'),
