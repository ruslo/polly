...
if(DEFINED POLLY_ANDROID_NDK_R12B_API_21_CPP_STATIC_X86_CMAKE_)
  return()
else()
  set(POLLY_ANDROID_NDK_R12B_API_21_CPP_STATIC_X86_CMAKE_ 1)
endif()
...
set(ANDROID_ABI "x86")
set(ANDROID_TOOLCHAIN_NAME "x86-clang")
