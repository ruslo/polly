...
if(DEFINED POLLY_OSX_10_13_DEP_10_10_CXX17_FPIC_CMAKE_)
  return()
else()
  set(POLLY_OSX_10_13_DEP_10_10_CXX17_FPIC_CMAKE_ 1)
endif()
...
LLVM Standard C++ Library (libc++) / c++17 support / Position-Independent Code"
    "Xcode"
)
