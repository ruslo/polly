...
if(DEFINED POLLY_ANDROID_NDK_R11C_API_21_CPP_STATIC_MIPS_CLANG_36_CMAKE_)
  return()
else()
  set(POLLY_ANDROID_NDK_R11C_API_21_CPP_STATIC_MIPS_CLANG_36_CMAKE_ 1)
endif()
...
set(ANDROID_TOOLCHAIN_NAME "mipsel-linux-android-clang3.6")
