...
if(DEFINED POLLY_FLAGS_CXX17_GNU_CMAKE_)
  return()
else()
  set(POLLY_FLAGS_CXX17_GNU_CMAKE_ 1)
endif()
...
elseif(_not_android)
  polly_add_cache_flag(CMAKE_CXX_FLAGS "-std=gnu++17")
else()
  polly_add_cache_flag(CMAKE_CXX_FLAGS_INIT "-std=gnu++17")
endif()
...
set(CMAKE_CXX_EXTENSIONS ON CACHE BOOL "C++ Standard extensions" FORCE) # GNU
